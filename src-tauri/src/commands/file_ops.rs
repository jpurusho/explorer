...
#[tauri::command]
pub async fn trash_items(paths: Vec<String>) -> Result<FileOpResult, AppError> {
...
#[tauri::command]
pub async fn move_items(paths: Vec<String>, destination: String) -> Result<FileOpResult, AppError> {
...
#[tauri::command]
pub async fn copy_items(paths: Vec<String>, destination: String) -> Result<FileOpResult, AppError> {
    let dest = Path::new(&destination);
    if !dest.is_dir() {
        return Err(AppError::Other(format!("Destination is not a directory: {}", destination)));
    }
...
#[tauri::command]
pub async fn rename_item(path: String, new_name: String) -> Result<String, AppError> {
