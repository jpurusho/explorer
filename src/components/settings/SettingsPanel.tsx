      ...
      <div className="flex-1 overflow-auto py-6 pl-6 pr-8">
        <SettingsSection title="Appearance">
          <div className="py-3 border-b border-border/30">
            <span className="text-[13px] text-text-secondary block mb-3">Theme</span>
            <div className="flex flex-wrap gap-2">
              <button
                onClick={() => setTheme("system")}
                className={clsx(
                  "px-3 py-1.5 rounded-[5px] text-[11.5px] font-medium border transition-all",
        ...
        <SettingsSection title="File Display">
          <SettingRow label="Default view">
            <div className="flex gap-1.5">
              <button
                ...
                className={clsx(
                  "px-3 py-1 rounded-[5px] text-[11.5px] font-medium transition-colors",
          ...
          <SettingRow label="Sort by">
            <select
              ...
              className="bg-bg-tertiary border border-border rounded-[5px] px-2.5 py-1 text-[11.5px] text-text-secondary outline-none"
            >
        ...
        <SettingsSection title="Editor">
          <div className="text-[11.5px] text-text-muted leading-relaxed">
            ...
            <div className="grid grid-cols-[80px_1fr] gap-y-2">
              <span className="text-text-secondary font-mono text-[11px]">i</span>
              <span>Enter insert mode</span>
              <span className="text-text-secondary font-mono text-[11px]">Esc</span>
              <span>Return to normal mode</span>
              <span className="text-text-secondary font-mono text-[11px]">:w</span>
              <span>Save file</span>
              <span className="text-text-secondary font-mono text-[11px]">⌘S</span>
              <span>Save file</span>
              <span className="text-text-secondary font-mono text-[11px]">⌘F</span>
              <span>Find in file</span>
              <span className="text-text-secondary font-mono text-[11px]">/pattern</span>
              <span>Vim search</span>
              <span className="text-text-secondary font-mono text-[11px]">dd</span>
              <span>Delete line</span>
              <span className="text-text-secondary font-mono text-[11px]">u</span>
              <span>Undo</span>
              <span className="text-text-secondary font-mono text-[11px]">Ctrl+r</span>
              <span>Redo</span>
            </div>
          </div>
        </SettingsSection>
        ...
        <SettingsSection title="Navigation">
          <div className="grid grid-cols-[80px_1fr] gap-y-2 text-[11.5px]">
            <span className="text-text-secondary font-mono text-[11px]">↑/↓</span>
            <span className="text-text-muted">Navigate files</span>
            <span className="text-text-secondary font-mono text-[11px]">Enter</span>
            ...
            <span className="text-text-secondary font-mono text-[11px]">⌘1</span>
            <span className="text-text-muted">List view</span>
            <span className="text-text-secondary font-mono text-[11px]">⌘2</span>
